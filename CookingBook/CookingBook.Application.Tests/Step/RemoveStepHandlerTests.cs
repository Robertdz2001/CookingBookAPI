...
public class RemoveStepHandlerTests
{
    ...
    {
        var command = new RemoveStep(Guid.NewGuid(), "Step");
        ...
        HandleAsync_Calls_Repository_On_Success()
    {
        ...
        recipe.AddStep(new Domain.ValueObjects.Step("Step"));
    ...
    private readonly ICommandHandler<RemoveStep> _commandHandler;
    public RemoveStepHandlerTests()
    {
        ...
        _commandHandler = new RemoveStepHandler(_repository, _authorization, _userContext);
    }
    #endregion
}
...
public class RemoveToolHandlerTests
{
        ...
        HandleAsync_Calls_Repository_On_Success()
    {
        ...
        recipe.AddTool(new Domain.ValueObjects.Tool("Tool",32));
    ...
    private readonly ICommandHandler<RemoveTool> _commandHandler;
    public RemoveToolHandlerTests()
    {
        ...
        _commandHandler = new RemoveToolHandler(_repository, _userContext, _authorization);
    }
    #endregion
}
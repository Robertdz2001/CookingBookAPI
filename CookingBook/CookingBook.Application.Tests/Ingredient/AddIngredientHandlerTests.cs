...
public class AddIngredientHandlerTests
{
    ...
    {
        var command = new AddIngredient(Guid.NewGuid(), "Ingredient", 32, 32);
    ...
    private readonly ICommandHandler<AddIngredient> _commandHandler;
    public AddIngredientHandlerTests()
    {
        ...
        _commandHandler = new AddIngredientHandler(_repository, _userContext, _authorization);
    }
    #endregion
}